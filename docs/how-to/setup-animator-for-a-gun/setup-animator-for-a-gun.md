...
| ReloadProgress    | float   | Simulated | Progress of magazine reloading (for Simplified Reload)               | 1.0.0~  |
| BulletsInMagazine | int     | Simulated | Amount of bullets available in the magazine                          | 1.0.0~  |
