...
namespace CenturionCC.System.Gimmick.WindZone
{
    ...
    public class WindZone : UdonSharpBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            for (var i = 0; i < _rigidbodies.Count; ++i)
            {
                ...
                var magnitudeAlongWind = Vector3.Dot(rb.velocity, windDirection);
                var relativeMagnitude = Mathf.Max(windPower - magnitudeAlongWind, 0);
                var forceMagnitude = windPower * relativeMagnitude * relativeMagnitude;
                rb.AddForce(WindDirection * forceMagnitude);
            }
        }
