...
namespace CenturionCC.System.Gimmick.Defuser
{
    ...
    public class DefuserText : UdonSharpBehaviour
    {
        private const int ProgressBarWidth = 45;
        private const int MiniDisplayProgressBarWidth = 30;
        private const string InitScreen =
            "|=======================================================================|\n" +
            "|                                                                       |\n" +
            "|  /$$$$$$$             /$$$$$$                                         |\n" +
            "| | $$__  $$           /$$__  $$                                        |\n" +
            ...
            "| | $$  | $$| $$_____/| $$     | $$  | $$ \\____  $$| $$_____/| $$       |\n" +
            "| | $$$$$$$/|  $$$$$$$| $$     |  $$$$$$/ /$$$$$$$/|  $$$$$$$| $$       |\n" +
            "| |_______/  \\_______/|__/      \\______/ |_______/  \\_______/|__/       |\n" +
            "|                                                                v0.2.0 |\n" +
            "|=======================================================================|\n" +
            "\n" +
            "(Pickup keyboard and interact | Press F) to defuse...\n";
        private const string TerminalPrefix = @"[<color=green>{0}@defuser-pc</color>: {1}]$ ";

        [SerializeField]
        private Text text;
        [SerializeField]
        private Text miniDisplayText;
        [SerializeField]
        private string miniDisplayIdle = "Waiting...";
        ...
        public virtual void DrawIdle(string username)
        {
            ...
            text.text = InitScreen + string.Format(TerminalPrefix, username, "~");
            miniDisplayText.text = miniDisplayIdle;
        }

        public virtual void PlantProgress(string username, float progress, int etaInSeconds)
        {
            username = FormatUsername(username);
            var resultText = InitScreen + string.Format(TerminalPrefix, "root", "~");
            if (progress > 0.05F)
            ...
            miniDisplayText.text = GetProgressBar(progress, MiniDisplayProgressBarWidth);
        }

        public virtual void PlantReady()
        {
            text.text += "\n<color=green>Defuser is ready. Place near the bomb to defuse...</color>\n";
            miniDisplayText.text = "Ready";
        }
        ...
        public virtual void CannotPlant(string username)
        {
            ...
            text.text += "\n<color=red>Could not find bomb near defuser. Stand near the bomb to begin...</color>\n" +
                         string.Format(TerminalPrefix, username, "~");
            miniDisplayText.text = "Bomb not found";
        }
